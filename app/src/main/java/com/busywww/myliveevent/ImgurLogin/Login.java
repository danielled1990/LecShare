package com.busywww.myliveevent.ImgurLogin;
...
public class Login extends Activity {
    ...
    public static final String MY_IMGUR_CLIENT_ID = "0f5bff89c481b55";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mWebView.loadUrl("https://api.imgur.com/oauth2/authorize?client_id=" + MY_IMGUR_CLIENT_ID + "&response_type=token");
    }
    ...
    private void setupWebView() {
        mWebView.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                ...
                if (url.startsWith(MY_IMGUR_REDIRECT_URL)) {
                    tokensURL = true;
                    Matcher m;
                    ...
                    Authorization.getInstance().saveRefreshToken(refreshToken, accessToken, expiresIn);

                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            //Toast.makeText(LoginActivity.this, android.R.id.string.logged_in, Toast.LENGTH_SHORT).show();
                            finish();
                        }
                    });
                }
