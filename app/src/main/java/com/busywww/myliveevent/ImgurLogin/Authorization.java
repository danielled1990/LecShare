...
public class Authorization  {
    ...
    public static final String MY_IMGUR_CLIENT_SECRET = "7c88a6060835f0c977203f7259188003cb1b0b51";
    public static final String MY_IMGUR_REDIRECT_URL = "";
        ...
        public String requestNewAccessToken() {
            ...
            try {
                ...
                nvps.add(new BasicNameValuePair("client_id", MY_IMGUR_CLIENT_ID));
                nvps.add(new BasicNameValuePair("client_secret", MY_IMGUR_CLIENT_SECRET));
